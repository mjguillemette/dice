  ...
  const createWallWithDoor = (
    ...
    doorsOnWall.forEach((door, idx) => {
      ...
      if (leftWidth > 0.1) {
        ...
        const leftPos = getWallSegmentPosition(
          wall,
          centerX,
          centerZ,
          width,
        ...
        const leftDims = getWallSegmentDimensions(
          wall,
          leftWidth,
          wallDepth,
          height
      ...
      if (rightWidth > 0.1) {
        ...
        const rightPos = getWallSegmentPosition(
          wall,
          centerX,
          centerZ,
          width,
        ...
        const rightDims = getWallSegmentDimensions(
          wall,
          rightWidth,
          wallDepth,
          height
...
function getWallPosition(
  ...
  switch (wall) {
    case "north":
      return [centerX, wallY, centerZ - depth / 2];
    case "south":
      return [centerX, wallY, centerZ + depth / 2];
    case "east":
      return [centerX + width / 2, wallY, centerZ];
    case "west":
      return [centerX - width / 2, wallY, centerZ];
  }
}
