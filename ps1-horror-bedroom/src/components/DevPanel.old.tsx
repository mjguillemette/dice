...
import { updateCollisionBoundsOffset, COLLISION_BOUNDS_OFFSET } from "../constants/receptacleConfig";
    ...
    >
      ...
      <div style={{ marginBottom: "20px" }}>
        ...
        <div style={{ paddingLeft: "10px" }}>
          ...
          <ObjectCounter
            label="Coins"
            count={coinCount}
            onChange={onCoinCountChange}
          />
          <ObjectCounter
            label="D3 Dice"
            count={d3Count}
            onChange={onD3CountChange}
          />
          <ObjectCounter
            label="D4 Dice"
            count={d4Count}
            onChange={onD4CountChange}
          />
          <ObjectCounter
            label="Thumb Tacks"
            count={thumbTackCount}
            onChange={onThumbTackCountChange}
          />
            ...
            >
              ...
              <button
                ...
                style={{
                  ...
                  border: `1px solid ${
                    showCardDebugBounds ? "#ffcc00" : "#666"
                  }`,
      ...
      <div style={{ marginBottom: "20px" }}>
        ...
        <div style={{ paddingLeft: "10px" }}>
          ...
          <div style={{ marginTop: "10px", fontSize: "10px", color: "#666", fontStyle: "italic" }}>
            Adjust collision bounds to match tray model.<br/>
      ...
      <div>
        ...
        <div style={{ paddingLeft: "10px", fontSize: "12px" }}>
          ...
          />
          <Stage name="PULSE" range="80-100%" active={hellFactor >= 0.8} />
        </div>
      </div>
...
function ObjectCounter({
  ...
  return (
    ...
    >
      <span style={{ color: "#888", fontSize: "12px", minWidth: "90px" }}>
        {label}:
      </span>
  ...
  return (
    <div style={{ marginBottom: "10px" }}>
      ...
      >
        ...
        <span
          style={{ color: "#00ff00", fontSize: "11px", fontWeight: "bold" }}
        >
          {displayVal}
          {unit}
        </span>
